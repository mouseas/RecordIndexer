...
public class RecordOld extends ObjectWithID{
	
	public RecordOld (List<Record> values) {
	 ...
	 */
	public String getValueByField(FieldOld f) {
		return null;
	}
	 ...
	 */
	public String search(String searchTerm, FieldOld searchField) {
		return null;
	}
